...
<head>
	...
	<title>Clubsportive | Natation</title>
...
<body>
	...
	<section class="main" id="info">
		...
		<a onclick="toggleMenu();" class="btn-card-two" href="reglement.txt" download="Reglement-ClubSportive" target="_blank" >Reglement</a>	
                ...
                <div  class="right">
                    <img src="./images/natation3.jpg" alt="">
                </div>
            </div>
            ...
            <div class="card">
                <div class="left">
        <div class="left-container">
                    <h2  class="titre-texte "> <span>TENUE</span>/ÉQUIPEMENT OBLIGATOIRE EN Natation</h2>
        ...
        <p>Information auprès de l’intervenant (affiliation nécessaire auprès de l’organisme qui régit le passage de grade).</p>
                ...
                <div  class="right">
                    <img src="./images/natation.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
