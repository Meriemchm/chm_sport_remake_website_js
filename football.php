...
<head>
	...
	<title>Clubsportive | football</title>
	...
	<section class="main" id="info">
		...
		<a onclick="toggleMenu();" class="btn-card-two" href="reglement.txt" download="Reglement-ClubSportive" target="_blank" >Reglement</a>	
            ...
            <div class="card">
                <div class="left">
        <div class="left-container">
                    <h2  class="titre-texte "> <span>TENUE</span>/ÉQUIPEMENT OBLIGATOIRE EN Football</h2>
                    <p> À commander auprès de l’intervenant au premier cours : </p>
					<ul>
						<li>Ensemble de foot.</li>
						<li>basket adaptee.</li>	
						<li>Accesoire de protection.</li>	
					</ul>
				</div>
				<div class="left-container">		
