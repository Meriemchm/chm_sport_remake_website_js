...
<head>
	...
	<link rel="stylesheet" href="escrime.css">
	<title>Clubsportive | Escrime</title>
...
<body>
	<header>
		...
		<ul class="navbar">
			<li><a href="index.php" onclick="toggleMenu();">&#9751 Accueil</a></li>
			<li><a href="#info" onclick="toggleMenu();">&#9871 A propos</a></li>
	...
	<section class="main" id="info">
		...
		<a onclick="toggleMenu();" class="btn-card-two" href="reglement.txt" download="Reglement-ClubSportive" target="_blank" >Reglement</a>	
                ...
                <div  class="right">
                    <img src="./images/escrime1.jpg" alt="">
                </div>
            </div>
            ...
            <div class="card">
                <div class="left">
        <div class="left-container">
                    <h2  class="titre-texte "> <span>TENUE</span>/ÉQUIPEMENT OBLIGATOIRE EN Escrime</h2>
                    <p> À commander auprès de l’intervenant au premier cours : </p>
					<ul>
						<li>Ensemble d'Escrime.</li>
						<li>l'épée.</li>	
					</ul>
				</div>
				<div class="left-container">		
        ...
        <p>Information auprès de l’intervenant (affiliation nécessaire auprès de l’organisme qui régit le passage de grade).</p>
                ...
                <div  class="right">
                    <img src="./images/escrime2.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
